      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          {filteredProjects.map((project) => {
            // Check if image is URL or gradient class
            ...
            return (
              ...
              >
                {/* Updated aspect ratios: large and medium = 16:9, small = 4:3 */}
                <div className={`w-full overflow-hidden rounded-sm relative ${
                  project.size === 'large' || project.size === 'medium' 
                    ? 'aspect-[16/9]'   // 16:9 for large and medium
                    : 'aspect-[4/3]'     // 4:3 for small
                }`}>
                  {/* Background - Support both URL and Gradient */}
